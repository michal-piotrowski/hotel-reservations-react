...
export default {
  ...
  /**
   * should be use with decimal geo minutes distance.Returns distance in meters 
   * e.g.(HrTool.distance(46.555453, 51.90001, 46.500541, 52))
   */ 
  distance(geoX1, geoY1, geoX2, geoY2) {
    return haversineDistance({ lat: geoX1, lon: geoY1 }, { lat: geoX2, lon: geoY2 }).toFixed(0);
  },
  formatGeo(lat, long) {
    return formatcoords(lat, long).format();
  },
  getDefaultMarker() {
